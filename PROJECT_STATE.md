...
Last successful step: Added `RECOVERY.md`, `memory/2026-06-29.md`, and the new-laptop installer checklist
Next step: Commit and push the updated recovery docs to GitHub, then verify remote sync
